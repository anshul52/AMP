  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow: scrolled ? "0 1px 0 rgba(92,15,30,0.10)" : "0 1px 0 rgba(92,15,30,0.04)",
    ...
    >
      ...
      <div className="hidden w-full justify-center lg:flex">
        <div className="flex h-20 w-full max-w-[1400px] items-center justify-between px-6 lg:px-10">
          <div className="flex items-center gap-12 xl:gap-[72px]">
            {/* Logo */}
            <Link href="/" aria-label="AMP HCC home" className="relative block shrink-0" style={{ width: 168, height: 44 }}>
              <Image src={LOGO} alt="AMP Human Capital Collective" fill className="object-contain object-left" priority />
            </Link>

            {/* Nav Links */}
            <div className="flex items-center">
              {navItems.map((item) => {
                const lit = hovered === item.label || (hovered === null && active === item.label);
                return (
                  <button
                    key={item.label}
      ...
      <div className="flex w-full justify-center lg:hidden">
        ...
        >
          <div className="flex items-center">
            <Link href="/" aria-label="AMP HCC home" className="relative block shrink-0" style={{ width: "clamp(120px, 34vw, 160px)", height: 38 }}>
              <Image src={LOGO} alt="AMP Human Capital Collective" fill className="object-contain object-left" priority />
            </Link>
          </div>
          ...
          <div className="flex items-center shrink-0">
            ...
            >
              {[{ y: menuOpen ? 0 : -6, r: menuOpen ? 45 : 0 }, { y: 0, r: 0, hide: menuOpen }, { y: menuOpen ? 0 : 6, r: menuOpen ? -45 : 0 }].map((bar, i) => (
                <span
                  key={i}
        ...
        <div className="flex w-full justify-center">
          ...
          {navItems.map((item) => (
            <button
              ...
              onMouseEnter={(e) => ((e.currentTarget as HTMLButtonElement).style.background = "#FFD5C2")}
          ...
          <button
            ...
            style={{ background: "#f85a1d", fontFamily: "var(--font-geist), Geist, sans-serif", fontSize: 15, fontWeight: 600 }}
          >
            Get In Touch
          </button>
        </div>
