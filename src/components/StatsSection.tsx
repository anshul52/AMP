...
const STATS = [
  { value: "10+",  label: "Countries where we've delivered projects" },
      ...
      <div ref={sectionRef} style={{ height: `${(N + 1) * 100}vh` }}>
        ...
        <div className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden bg-[#fff4ef]">
          ...
          <div
            ...
            style={{ width: "clamp(300px, 51vw, 735px)", height: "clamp(300px, 50.6vw, 729px)" }}
          >
            <GlobeScene />
          </div>
          ...
          >
            <p
              ...
              style={{
                ...
                fontSize:      "clamp(80px, 13.9vw, 200px)",
                fontWeight:    900,
                lineHeight:    "0.931",
